...
<div class="max-w-xl mx-auto my-16 px-4">
    <div class="bg-white rounded-3xl border border-slate-100 shadow-2xl p-8 sm:p-10 relative overflow-hidden">
        ...
        <div class="text-center relative z-10">
            ...
            <h2 class="text-3xl font-extrabold tracking-tight text-slate-900 mt-4">Complete Profile Setup</h2>
            <p class="mt-2 text-sm text-slate-500 font-light">Tell us more about your business to start bidding.</p>
        </div>
        ...
        <form action="{{ route('profile.setup') }}" method="POST" enctype="multipart/form-data" class="mt-8 space-y-6 relative z-10">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                ...
                <div class="relative group cursor-pointer">
                    <div id="imagePreviewContainer" class="w-28 h-28 rounded-2xl bg-slate-50 border-2 border-dashed border-slate-200 flex items-center justify-center overflow-hidden transition-all group-hover:border-emerald-500">
                        <svg id="uploadIcon" class="w-8 h-8 text-slate-400 group-hover:text-emerald-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            ...
            @if($user->role === 'farmer')
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="text" id="farm_name" name="farm_name" value="{{ old('farm_name') }}" required class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm shadow-sm transition-all" placeholder="Green Valley Farms">
            ...
            @else
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="text" id="business_name" name="business_name" value="{{ old('business_name') }}" required class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm shadow-sm transition-all" placeholder="AgriFoods Trading Corp">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                            <!-- brief case icon -->
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" required class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm shadow-sm transition-all" placeholder="+91 98765 43210">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="space-y-2">
                    ...
                    <input type="text" id="state" name="state" value="{{ old('state') }}" required class="w-full px-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm shadow-sm transition-all" placeholder="Punjab">
                </div>
                <div class="space-y-2">
                    <label for="city" class="text-sm font-bold text-slate-700">City</label>
                    <input type="text" id="city" name="city" value="{{ old('city') }}" required class="w-full px-4 py-3.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm shadow-sm transition-all" placeholder="Ludhiana">
                </div>
            </div>
