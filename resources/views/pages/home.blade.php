...
@section('title', 'Home - AgriMandi')
@section('content')

@php
$tickerItems = isset($prices) ? $prices->map(fn($p) => $p->commodity . ': ₹' . number_format($p->modal_price) . '/q') : collect(['Wheat: ₹2,100/q','Rice: ₹3,200/q','Tomato: ₹1,800/q','Onion: ₹2,500/q','Soybean: ₹4,500/q']);
@endphp
